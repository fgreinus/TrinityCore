...
class TC_GAME_API ObjectMgr
{
    ...
    public:
        ...
        float GetOCTRegenHP(uint32 class_, uint8 level) const;
        float GetRegenHPPerSpt(uint32 class_, uint8 level) const;
        float GetRegenMPPerSpt(uint32 class_, uint8 level) const;
